...
task(
  ...
  console.log(
    `NFT contracts deployed to local node at http://localhost:8545 (Chain ID: ${chainId})`,
  );
  // console.log(`Auction House Proxy address: ${contracts.RadaAuctionHouseProxy.instance.address}`);
  console.log(`Rada ERC721 address: ${contracts.RadaToken.instance.address}`);
  // console.log(`Rada DAO Executor address: ${contracts.RadaDAOExecutor.instance.address}`);
  // console.log(`Rada DAO Proxy address: ${contracts.RadaDAOProxy.instance.address}`);
